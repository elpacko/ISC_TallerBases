...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    <meta charset="utf-8">
    <title><?php echo has_content('title') ? yieldC('title', false) . ' - ' : ''; ?>[SITE NAME]</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <base href="<?php echo $config['base_url']; ?>">
    <!--[if ! lte IE 6]><!-->
      <link rel="stylesheet" href="css/application.css">
      <?php yieldC('stylesheets'); ?>
    <!--<![endif]-->
    <!--[if lte IE 6]>
  ...
  <body>
    ...
    <!--[if ! lte IE 6]><!-->
      ...
      <?php javascripts('script'); yieldC('javascripts'); ?>
    <!--<![endif]-->
    ...
    <h1>Test 001</h1>
    <?php echo returnJSONFromQuery('select * from Pais;'); ?>
